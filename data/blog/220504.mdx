...
- [x] DeepDiver Js # 38 브라우저의 렌더링 과정
- [x] InstaClone Front part 1 ~ # 8.8
- [x] Side Project : 'ToDoPod App'

<br />

# DeepDive JS Ch.38 브라우저의 렌더링 과정
...
- [x] Architecture
- [x] Styles System : styled-components

### Router

- _react-router-dom V6 로 진행_
...
- react-router-dom 을 이용하여 url 과 component를 매칭시킬 수 있다.
- Apollo Reactive Variables 를 이용하여 variable 의 state를 전역에서 쉽게 관리할 수 있다.
- styled-components 를 이용하여 CSS를 component 단위로 prop 을 이용하여 쉽게 적용할 수 있다.
- s-c 의 ThemeProvider 와 Reactive Variables를 이용하여 Theme를 전역적으로 쉽게 처리할 수 있다.

<br />

# Project : 'ToDoPod'

- github : https://github.com/geonya/todopod-back/commit/de52c8ec2998ade5887d878357159ace3acd3229

- project / todo / hashtag / photo schema 에 CRUD 기능을 구현하기 위해 `type definition` 과 `resolver` 들을 만듦
- photo 와 avatar image file이 AWS S3 에서 edit 이나 delete 할 경우 기존 file 이 삭제 되도록 함
- 각 model 을 지정할 경우 연결된 model 들을 같이 볼 수 있도록 resolver 파일을 수정함
- project에서 prisma where contains ? 를 이용해 search 기능을 구현함
- [ ] comment 기능을 어떻게 구현할지 고민 중
- [ ] front UI layout 구상해야함- [ ] Search ToDos
